...
def init_all_databases():
 ...
 # 1. Academic DB
 conn_ac = sqlite3.connect(ACADEMIC_DB)
 ...
 # 2. Zannie DB
 conn_za = sqlite3.connect(ZANNIE_DB)
 ...
 print("[+] All databases synchronized and verified successfully.") 
...
def global_system_health():
 return jsonify({
 "status": "online",
 "environment": "Unified Staging Matrix",
 "modules_active": [
